...
namespace AccesoriosArgentinos.Migrations
{
    ...
    [Migration("20220623180543_MaterialLista")]
    partial class MaterialLista
    {
            ...
            modelBuilder.Entity("AccesoriosArgentinos.Modelos.Pieza", b =>
                {
                    ...
                    b.Property<string>("PosicionExpulsor")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AccesoriosArgentinos.Modelos.Pieza", b =>
                {
                    ...
                    b.HasOne("AccesoriosArgentinos.Modelos.Material", null)
                        .WithMany("Piezas")
                        .HasForeignKey("MaterialId");
